        ...
        {loading ? (
          ...
          <div className="mx-auto flex w-11/12 max-w-maxContent flex-col-reverse justify-between gap-y-12 py-12 md:flex-row md:gap-y-0 md:gap-x-12">
            <div className="mx-auto w-11/12 max-w-[450px]  md:mx-0">
              ...
              {formType === "login" ? (
                <div className="flex w-full items-center ml-20 my-4 gap-x-2">
              ...
              {formType === "login" ? (
                <button
                  className="w-full flex flex-row justify-center items-center rounded-[8px] ml-20 font-medium text-richblack-100
            ...
            <div className="relative mx-auto w-11/12 max-w-[450px] mt-[220px] md:mx-0">
              <img
                src={frameImg}
                alt="Pattern"
                width={558}
